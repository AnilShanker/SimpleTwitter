...
No significant challeneges were encountered when building the app.
...
**SimpleTwitter** is an Android app that allows a user to view their Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='SimpleTwitter_walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
